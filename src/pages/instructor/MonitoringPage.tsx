...
export function MonitoringPage() {
  return (
    <div className="page-stack monitoring-page">
      <h1 className="visually-hidden">المراقبة المباشرة</h1>
      <div
        className="monitor-legend panel monitoring-page__legend"
        role="group"
      ...
      <section
        className="panel monitoring-page__grid-wrap"
        aria-label="عرض شبكة الطلاب الحاضرين"
      >
        <h2 className="panel__title">
          عرض الشبكة (Grid View) — الطلاب الحاضرون
        </h2>
        <p className="panel__hint">
